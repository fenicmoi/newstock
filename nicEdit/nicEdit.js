...
//		'outdent' : {name : __('Remove Indent'), command : 'outdent', noActive : true},
	...
	buttonList : ['fontSize','fontFormat','save','bold','italic','underline','left','center','right','justify','ol','ul','indent','outdent','forecolor','bgcolor','image','upload','link','unlink','subscript','superscript','strikethrough','removeformat','hr','xhtml'],
//	buttonList : ['fontSize','fontFamily','fontFormat','save','bold','italic','underline','left','center','right','justify','ol','ul','indent','outdent','forecolor','bgcolor','image','upload','link','unlink'],
//	buttonList : ['save','bold','italic','underline','left','center','right','justify','ol','ul','fontSize','indent','outdent','image','upload','link','unlink','forecolor','bgcolor'],
...
var nicEditorInstance = bkClass.extend({
	...
	construct : function(e,options,nicEditor) {
		...
		if(isTextarea || this.options.hasPanel) {
			...
			var s = {width: newX+'px', border : '1px solid #ccc', backgroundColor : '#ffffff', borderTop : 0, overflowY : 'auto', overflowX: 'hidden' };
...
var nicEditorIFrameInstance = nicEditorInstance.extend({
	...
	initFrame : function() {
		...
		fd.write('<html><head>'+((css) ? '<link href="'+css+'" rel="stylesheet" type="text/css" />' : '')+'</head><body id="nicEditContent" style="margin: 1 !important; background-color: transparent !important;">'+this.initialContent+'</body></html>');
		fd.close();
		this.frameDoc = fd;
...
var nicCodeButton = nicEditorAdvancedButton.extend({
	...
	addPane : function() {
		this.addForm({
			...
			'code' : {type : 'content', 'value' : this.ne.selectedInstance.getContent(), style : {width: '616px', height : '179px'}}
		});
	},
