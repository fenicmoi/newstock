...
<div class="row">
 <div class="col-md-4">
    ...
    <blockquote class="note yellow">
        <i class="fas fa-chat"></i> <kbd>เกี่ยวกับระบบ</kbd> <br>
            <ol>
                <li>รวบรวมข้อมูลเพื่อการบริหารจัดการจังหวัด</li>
                <li>ข้อมูลโครงการทุกโครงการ</li>
                <li>ข้อมูลทรัพย์สินจังหวัด</li>
            </ol>
...
<div class="col-md-4">
 ...
 <div class="col-md-4">
    ...
    <i class="pin"></i>
    <blockquote class="note yellow">
        <i class="fas fa-chat"></i><kbd>Module ระบบอื่นๆ</kbd> <br>
           สนจ.พท จะดำเนินการพัฒนาระบบอื่นๆ  เพื่ออำนวยความสะดวกให้มากยิ่งข้น
           <!-- <ol>
