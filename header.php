...
<html lang="en">
  <head>
    ...
    <meta name="description" content="ระบบสารสนเทศบริหารจัดการโครงการจังหวัดพัทลุง">
...
?></a>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav ">
              ...
              <li><a class="btn-link"  href="http://www.phatthalung.go.th" target="_blank"><i class="fas fa-retweet"></i> ข้อมูลจังหวัดพัทลุง</a></li>
              ...
              <li><a  class="btn disabled"  href="#" data-toggle="modal" data-target="#modelRule">เกี่ยวกับระบบ</a></li>
          </ul>
