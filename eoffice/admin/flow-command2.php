            ...
            <div class="panel-body">
                <table class="table table-bordered table-hover" id="tbCommand">
                    ...
                    while($row=dbFetchArray($result)){
                        ...
                        // $dateStart="2018-09-10";  //วันที่เริ่มบังคับให้ใส่ไฟล์
                        // $dateOut=$row['dateout'];
                        // $da1=strtotime($dateOut);
                        // $da2=strtotime($dateStart);
                    ?>
                        <tr>
                            <td> 
                            <?php 
                    ...
                    <?php 
                            $file_upload=$row['file_upload'];
                            if($file_upload==''){ ?>
                            <td> <a class="btn btn-danger" href="#" onclick="load_leave_data('<?php print $u_id;?>','<?php print $cid;?>','<?php print $edit=0;?>');" data-toggle="modal" data-target=".bs-example-modal-table"><i class="fas fa-paperclip"></i> แนบไฟล์ </a></td>
                    <? }else{ ?>
