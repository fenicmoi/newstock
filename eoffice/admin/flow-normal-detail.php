...
// $_SESSION['cid']=$cid;  //สร้างตัวแปร session เพื่อส่งค่าไปหน้าหลัก
 ...
 switch ($status) {
    case 0:
         $staTex="ยกเลิก/ส่งคืน";
         break;
    case 1:
        $staTex="เลยกำหนด";
        break;
    case 2:
        $staTex="อยู่ระหว่างดำเนินการ";
        break;
    case 3:
        $staTex="ปิดงานแล้ว";
        break;
...
/*if ($paper==null){   //ตรวจสอบว่าไฟล์เอกสารมีหรือไม่
    $paper='-ไม่มี-';
}else{
    $paper="<button class=\"btn btn-primary fa fa-file-pdf-o\">Click!</button>";
}*/
?>
        <div class="col-md-2" >
                ...
                <div class="panel-body">
                    <div class="form-group form-inlinet">
                        <form name="form" method="POST">
                            <a href="flow-normal.php" class="fa fa-home btn btn-primary text-left"> หน้าหลัก</a>
                            <a href="paper.php" class="fa fa-send btn btn-primary text-left">ส่งเอกสาร</a>
                            <button class="fa fa-eye btn btn-primary"> ติดตาม</button>
                           <!-- <button class="fa fa-edit btn btn-primary"> แก้ไข</button> -->
                           <button class="btn btn-primary fa fa-check" type="submit" name="check"> ปิดงาน
                             <input id="cid" name="cid" type="hidden" value="<?php print $rowDetail['cid']; ?>"> 
                           </button>
                            <a href="flow-normal.php" class="fa fa-undo btn btn-primary text-left"> ย้อนกลับ</a>
                            <!-- <button class="btn btn-success fa fa-check" href="flow-normal-edit" type="submit" name="edit"> แก้ไขเอกสาร -->
                             <input id="cid" name="cid" type="hidden" value="<?php print $rowDetail['cid']; ?>"> 
                           </button>
                        </form>
                    </div>
