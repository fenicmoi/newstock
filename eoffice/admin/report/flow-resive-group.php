                ...
                <div class="panel-heading"><i class="fa fa-university fa-2x"></i>  <strong>หนังสือรับกลุ่มงาน</strong>
                    <div class="btn-group btn-grouop-lg pull-right">
                       ...
                       <div class="dropdown pull-right">
                            <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-print"></i>พิมพ์รายงาน
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql="SELECT fr.*,y.yname,u.firstname FROM flow_recive_group as fr 
                                      ...
                                      WHERE fr.sec_id=$sec_id ORDER BY fr.cid DESC";
                               // print $sql;
                                $result=dbQuery($sql);
                            ...
                            <div class="form-group col-md-5">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" name="practice">
                                        <?php
                                            while ($row=dbFetchArray($result)) {?>
                                                <option value="<?=$row['u_id']?>"><?php echo $row['firstname'];?></option>
                                           <? } ?>
                                    </select>
                                </div>
                            </div>
