                        ...
                        <center>
                            <table width="auto" border="0">
                                ...
                                <tr>
                                    ...
                                    <td><input disabled="" type="text" class="form-group-sm" name="date_book" value="<?php print thaiDate($row['date_book']); ?>" ></td>
                                    <td><label for="date_in">วันที่บันทึก:</label><input disabled="" type="text" class="form-group-sm" name="date_in" value="<?php print thaiDate($row['date_in']); ?>"></td>
                                </tr>
                                <tr>
                                ...
                                <?php
                                    ...
                                    if ($practice!='') {
                                        ...
                                        <td><label for="practice">หน่วยปฎิบัติ</label></td>
