...
<div class="row">
        ...
        <div class="col-md-10">
            <div class="panel panel-primary" style="margin: 10">
                <div class="panel-heading"><i class="fas fa-database fa-2x"></i>   <strong>Backup Database</strong>
                </div> <!-- heading -->
                <div class="panel-body">
                     <form method="post">
                        <button type="submit" name="btnBackup" id="btnBackup" class="btn btn-warning pull-right"><i class="fas fa-hdd"></i> Backup</button>
                        <button type="submit" name=btnRestore" id="btnRestore" class="btn btn-danger pull-right"><i class="fas fa-history"></i> Restore</button>
                    </form>
                    <?php   //list of directory
                        ...
                        if(isset($_POST['btnBackup'])){
                               /**
                                    ...
                                    class Backup_Database {
                                            ...
                                            try {
                                                ...
                                                */
                                                foreach($tables as $table) {
                                                    $this->obfPrint("กำลังสำรอง ตาราง `".$table."` ...".str_repeat('.', 50-strlen($table)), 0, 0);
                                        ...
                                        */
                                        protected function gzipBackupFile($level = 9) {
                                            ...
                                            $this->obfPrint('ระบบบีบอัดข้อมูลและจัดเก็บไว้ที่..' . $dest . '... ', 1, 0);
                                    ...
                                    */
                                    ...
                                    $backupDatabase->obfPrint('ผลการดำเนินการ: ' . $result, 1);
