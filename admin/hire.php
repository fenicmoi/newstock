    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="panel panel-primary" style="margin: 10">
                <div class="panel-heading"><i class="fas fa-cart-plus fa-2x"></i>   <strong>ทะเบียนคุมสัญญาจ้าง</strong>
                    <a href="add_object.php" class="btn btn-default  pull-right" data-toggle="modal" data-target="#modalAdd"><i class="fa fa-plus" aria-hidden="true"></i> ออกเลขที่สัญญา</a>
									<a href="#" class="btn btn-default pull-right"><i class="fas fa-chart-pie"></i>สถิติข้อมูล</a>
						...
						?>
                            <tr>
                               ...
                               <td><?php echo number_format($row['money']); ?></td>
								...
								<td><a href="report/rep-hire-item.php?hire_id=<?php print $hire_id?>" class="btn btn-warning" target="_blank"><i class="fas fa-print"></i></a></td>
                            </tr>
                        <?php } ?>
                 </tbody>
                </table>
                  ...
                  <div class="modal-body">
                      <form method="post">
                        ...
                        <div class="form-group form-inline">
                            <div class="input-group">
                             <span class="input-group-addon"><label for="datehire">ลงวันที่ :</label></span>
