        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="#">
                    ...
                    <div class="form-group">
                        <div class="input-group ">
                            <span class="input-group-addon" id="basic-addon1">กลุ่มครุภัณฑ์</span>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1">ประเภทครุภัณฑ์</span>
                    ...
                    <div class="form-group">
                       <div class="input-group">
                            <span class="input-group-addon" id="basic-addon1">ชนิดครุภัณฑ์</span>
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" id="amount" name="amount"  class="form-control col-2" value="1" required>
                        </div>   
                    </div>
                    <div class="form-group">
                        <div class="input-group">
