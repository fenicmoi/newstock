...
<div class="row">
    ...
    <div class="col-md-10">
        <div class="panel panel-primary" style="margin: 10">
            <div class="panel-heading"><i class="fas fa-cart-plus fa-2x"></i>   <strong>จัดการประเภทครุภัณฑ์</strong>
                <a href="add_object.php" class="btn btn-default  pull-right" data-toggle="modal" data-target="#modelId"><i class="fa fa-plus" aria-hidden="true"></i> เพิ่มประเภทครุภัณฑ์</a>
			</div> 
